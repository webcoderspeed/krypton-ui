---
title: Accordion
description: A collapsible content component that allows users to expand and collapse sections of content.
---

# Accordion

A flexible accordion component that allows users to show and hide sections of related content on a page. Built on top of Radix UI with full accessibility support and smooth animations.
...
```tsx
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from 'krypton-ui'
```

## Basic Usage

The Accordion component provides an intuitive way to organize content in collapsible sections.

<CodePreview
  code={`import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from 'krypton-ui'
...
Allow multiple accordion items to be open simultaneously by setting the type to "multiple".
  ...
  return (
    <Accordion type="multiple" className="w-full">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          Learn the basics of our design system and how to integrate it into your project.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
      ...
      <AccordionItem value="item-3">
        ...
        <AccordionContent>
          Customize components to match your brand and design requirements.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  )
...
Disable specific accordion items or the entire accordion component.
...
Set default open items using the defaultValue prop.
  ...
  return (
    <Accordion type="single" collapsible defaultValue="item-2" className="w-full">
      ...
      <AccordionItem value="item-3">
        ...
        <AccordionContent>
          This section also starts closed.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  )
...
```tsx
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger, LucideIcon } from 'krypton-ui'
