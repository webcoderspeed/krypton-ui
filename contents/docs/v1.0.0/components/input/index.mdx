...
Explore different Input implementations and use cases.
...
<CodePreview
  code={`<form className="w-full max-w-sm space-y-4">
  ...
  language="tsx"
  preview={<FormInputDemo />}
/>

## API Reference

Detailed API reference for the Input component and its props.
